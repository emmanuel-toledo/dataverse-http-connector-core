...
namespace Dataverse.Http.Connector.Core.Utilities
{
    ...
    internal static class FetchXmlBuilderUtilities
    {
        ...
        public static string CreateEntityFetchXmlQuery<TEntity>(FetchXml model, Entity entityAttributes, ICollection<Field> fieldsAttributes, bool isLogger = false) where TEntity : class, new()
        {
        ...
        /// <param name="fieldsAttributes">Field attributes collection of TEntity class.</param>
        /// <returns>FetchXml query.</returns>
        public static string CreateCountFetchXmlQuery<TEntity>(FetchXml model, Entity entityAttributes, ICollection<Field> fieldsAttributes) where TEntity : class, new()
        {
            // Create new XML for query document.
            var xDocument = new XDocument();
            // Create main element.
